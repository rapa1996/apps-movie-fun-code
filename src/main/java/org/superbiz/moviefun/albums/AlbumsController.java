...
public class AlbumsController {
    ...
    public HttpEntity<byte[]> getCover(@PathVariable long albumId) throws IOException, URISyntaxException {
        ...
        Blob coverBlob = maybeBlob.orElseGet(this::buildDefaultCoverBlob);
    ...
    private Blob buildDefaultCoverBlob(){
        return new Blob("default-cover.jpg", ClassLoader.getSystemResourceAsStream("default-cover.jpg"), IMAGE_JPEG_VALUE);
    }
}
